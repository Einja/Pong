...
function love.update(dt)
    ...
    -- player 2 but controlled by CPU (very difficult to win against)
...
function love.draw()
    ...
    if gameState == 'start' then
        ...
        love.graphics.printf('First to 5 wins!', 0, 20, VIRTUAL_WIDTH, 'center')
        love.graphics.printf('Press Enter to begin!', 0, 30, VIRTUAL_WIDTH, 'center')
    elseif gameState == 'serve' then
        -- UI messages
        love.graphics.setFont(smallFont)
        if player1Score > 0 or player2Score > 0 then
            love.graphics.printf('Player ' .. tostring(scoringPlayer) .. " score!", 0, 0, VIRTUAL_WIDTH, 'center')
        end
